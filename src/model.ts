 ...
 * epic
 */
export type TEpic<TActionInput extends Action<any>, TActionOutput extends Action<any>, TStoreState, TDeps> =
  (action$: ActionsObservable<TActionInput>, store: Store<TStoreState>, deps: TDeps) => Observable<TActionOutput>;
